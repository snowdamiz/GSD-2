...
- M008 is in progress: Web polish — projects page redesign (S01 done), browser update UI (S02 done), theme defaults and color audit, remote questions settings, dynamic progress bar, terminal text size preference.
